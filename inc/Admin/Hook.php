...
class Hook{
    ...
    function __construct(){
         ...
         * @remove_permalink_under_title 
         */
        add_filter('get_sample_permalink_html', [ $this, 'remove_permalink_under_title'], 10, 4);
        /**
         * Remove Permalink quick edit button from view list with below mention method
         * @remove_quick_edit_view_actions 
         */
        add_filter('post_row_actions', [$this,  'remove_quick_edit_view_actions'], 10, 2);
        /**
         * Added Short code Column with with below mention method.
         * @add_shortcode_column 
         */
        add_filter('manage_formit_posts_columns', [$this, 'add_shortcode_column']);
        /**
         * Display hortcode column in the View list page with with below mention method.
         * @display_shortcode_column 
         */
        add_action('manage_formit_posts_custom_column', [$this, 'display_shortcode_column'], 10, 2);
        
        /**
         * Added Short code Column with with below mention method.
         * @add_mail_Count_column 
         */
        add_filter('manage_formit_posts_columns', [$this, 'add_mail_Count_column']);
        
        /**
         * Added Short code Column with with below mention method.
         * @add_author_column 
         */
        add_filter('manage_formit_posts_columns', [$this, 'add_author_column']);

        /**
         * Display shortcode column in the View list page with with below mention method.
         * @display_mail_count_column 
         */
        add_action('manage_formit_posts_custom_column', [$this, 'display_mail_count_column'], 10, 2);
        
        /**
         * Display shortcode column in the View list page with with below mention method.
         * @display_author_column 
         */
        add_action('manage_formit_posts_custom_column', [$this, 'display_author_column'], 10, 2);

         /**
         *  screeen option remove
         * @display_author_column 
         */
        add_filter("manage_formit_posts_columns", [$this, "remove_screen_options_for_custom_post_type"]);
        ...
        add_action('admin_enqueue_scripts', [$this, 'disable_autosave_interval_for_custom_post_type']);
        
        /**
         * Change the title placeholder name
         * callback @custom_post_title_placeholder
         */
        add_filter('enter_title_here', [$this, 'custom_post_title_placeholder'], 10, 2);

        /**
         * Publish metabox remove 
         * @remove_publish_meta_box_from_custom_post_type
         */
        add_action('add_meta_boxes', [$this, 'remove_publish_meta_box_from_custom_post_type']);
    
        /**
         * Sidebar Metabox remove
         * @remove_sidebar_from_custom_post_type
         */
        add_action('add_meta_boxes', [$this, 'remove_sidebar_from_custom_post_type']);

        /**
         * Screen tab option remove function
         * callback @remove_screen_options_tab
         */
        add_filter('screen_options_show_screen', [$this, 'remove_screen_options_tab'], 10, 2);

        /**
         * Button added on PLugin page
         * callback @add_settings_link;
         */
         ...
         */
        add_action('current_screen', [$this, 'disable_notices_for_custom_post_type']);
    ...
    /**
     * disable_notices_for_custom_post_type function
     *
     * @return void
     */
    function disable_notices_for_custom_post_type() {
     ...
     * @return void
     */
    function remove_screen_options_tab($display, $screen) {
     ...
     * @return void
     */
    function remove_sidebar_from_custom_post_type() {
        // Replace 'your_custom_post_type' with the name of your custom post type.
     ...
     * callback @remove_publish_meta_box_from_custom_post_type
     * @return void
     */
    function remove_publish_meta_box_from_custom_post_type() {
        // Replace 'your_custom_post_type' with the name of your custom post type.
    ...
    */
    function remove_permalink_under_title($return, $id, $new_title, $new_slug) {
    ...
    /*  This Filter hook apply for remove view button and quick edit
        Developer need to read
    */
    function remove_quick_edit_view_actions($actions, $post) {
    ...
    */
    ...
    /*  Add a custom column to the post list screen for Mail count
        Developer need to read
    */
    function add_mail_Count_column($columns) {
    ...
    */
    function display_mail_count_column($column, $post_id) {
        global $wpdb;
        ...
        if ($column === 'mailcount') {
            // Get the generated shortcode from post meta
            $total = new Query();
            $totalCount = $total->count_form_entries($form_id);
    ...
    */
     ...
     * @return void
     */
    function remove_screen_options_for_custom_post_type($columns) {
    ...
    * @return void
    */
    function disable_autosave_interval_for_custom_post_type() {
        global $typenow;
        // Replace 'your_custom_post_type' with the name of your custom post type.
        if ($typenow == 'formit') {
