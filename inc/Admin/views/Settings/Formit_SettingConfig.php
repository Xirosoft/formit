...
if ( ! class_exists( 'Formit_SettingConfig' ) ) {
    class Formit_SettingConfig{
        private $query; 
        private $wpdb;
        private $table_name;
        private $data_format;
        ...
        function __construct(){
            add_action('wp_ajax_formit_form_settings_data', [$this, 'formit_form_settings_data']);
            add_action('wp_ajax_nopriv_formit_form_settings_data', [$this, 'formit_form_settings_data']); // For non-logged-in users

            global $wpdb;
            $this->wpdb = $wpdb;
        
            $this->table_name = $wpdb->prefix . 'formit_settings'; // Replace 'ms_form_data' with your custom table name
            $this->query = new Formit_Query();
        ...
        * @return void
        */
        function formit_form_settings_data(){
            ...
            if (isset($_POST['formData'])) {
                ...
                $raw_data = wp_unslash(sanitize_textarea_field($_POST['formData']));
            ...
            if (empty($this->existing_data)) {
                ...
                // Insert the data
                $this->query->formit_insert_data($this->table_name, $data_to_insert, $defaults);
                ...
                // Update the data
                $this->query->formit_update_data( $this->table_name, $updated_data, $where);
        ...
        * $formit_form_settings_config_data
        * @return void
        */
        function formit_setting_tab(){
            ...
            $user_defined_settings = $this->formit_form_settings_config_data();

            // Update the SettingsArray
            $SettingsArray = $this->formit_update_settings_data($pre_defined_settings, $user_defined_settings);
                ...
                <table class="form-table form-element-table">
                    ...
                    <tr>
                        ...
                        <td class="option-value-col">
                            ...
                            <label for="<?php echo esc_attr($field['name']) ?>"></label>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
        ...
        * @return array
        */
        function formit_form_settings_config_data(){
            if($this->where['id'] != null){ }
            $rows = $this->query->formit_view_data($this->table_name, array('id' => $this->where['id']));
        ...
        * @return void
        */
        function formit_update_settings_data($pre, $new) {
            if(count($new) > 0) {
