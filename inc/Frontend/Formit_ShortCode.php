...
/* 
* Shortcode Builder 
* @formit_save_builder_shortcode method
*/
if ( ! class_exists( 'Formit_ShortCode' ) ) {
    class Formit_ShortCode{
        function __construct(){
            /**
            * Register the shortcode form builder action hook wtih below method
            * @formit_shortcode_form_builder
            */
            add_shortcode('formit',[$this, 'formit_shortcode_form_builder']);
        }
        ...
        * 
        */
        function formit_shortcode_form_builder($atts) {
