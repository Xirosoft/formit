...
use Xirosoft\Formit\Admin\views\Settings\Formit_SettingConfig;

if ( ! class_exists( 'Formit_AdminEnqueue' ) ) {
    class Formit_AdminEnqueue{
        function __construct(){
            add_action('admin_enqueue_scripts', [$this, 'formit_enqueue_dashboard_scripts']);
            add_action('admin_enqueue_scripts', [$this, 'formit_builder_form_data']);
            add_action('admin_enqueue_scripts', [$this, 'formit_ajax_localie']);
        }
        
        function formit_enqueue_dashboard_scripts($hook) {
        ...
        * @return void
        */
        function formit_builder_form_data($json_localize){
            ...
            */
            ...
            wp_localize_script('formit-admin-scripts', 'formit_scripts_localize', array(
                ...
                'formit_form_settings_data' => $settingconfig->formit_form_settings_config_data(),
            ));
