...
if ( ! class_exists( 'Formit_Query' ) ) {
    class Formit_Query {
        ...
        * @return void
        */
        public function formit_insert_data($table_name, $data, $defaults) {
            // global $wpdb;
        ...
        * @return void
        */
        public function formit_update_data($table_name, $data, $where) {
            // global $wpdb;
        ...
        * @return void
        */
        // public function formit_view_data($table_name, $where) {
        //     global $wpdb;
        ...
        public function formit_view_data($table_name, $where_conditions) {
        ...
        */
        ...
        public function formit_count_form_entries($form_id) {
        ...
        * @return string
        */
        public function formit_get_single_row($table_name, $where){
        ...
        * @param [string] $where
        */
        public function formit_get_all_form_id($table_name){
        ...
        * @return void
        */
        public function formit_total_submitions(){
        ...
        * @return array
        */
        public function formit_last_submitions($quantity){
        ...
        * @return void
        */
        public function formit_total_forms(){
            // Define the table name
        ...
        * @return void
        */
        public function formit_todays_submission_count() {
            // Define the table name
            $table_name = $this->wpdb->prefix . 'formit_submissions'; // Replace 'formit_' with your table prefix if different
            // Get the current date in MySQL date format (YYYY-MM-DD)
            $current_date = gmdate('Y-m-d');
            // Query to count records inserted today
            $query = $this->wpdb->prepare("SELECT COUNT(*) FROM %s WHERE DATE(created_at) = %s", $table_name, $current_date);
            // total count
            // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
        ...
        * @return void
        */
        public function formit_get_email_from_mail_body($formbody){
        ...
        * @return void
        */
        public function formit_get_submission_data() {
            // global $wpdb;
            $table_name = $this->wpdb->prefix . 'formit_submissions';
            $query = "SELECT * FROM %1s";
