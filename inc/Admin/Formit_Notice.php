...
if ( ! class_exists( 'Formit_Notice' ) ) {
    class Formit_Notice  {
        public function __construct() {
            add_action('admin_notices', array($this, 'formit_display_notice'));
        }

        public function formit_display_notice() {
            ...
            if (!get_user_meta(get_current_user_id(), $dismissed_notice)) {
                ...
                <div class="notice notice-info is-dismissible">
                    <p>
                        ...
                        <a href="<?php echo esc_url($route->formit_create_url()); ?>"><?php echo esc_html__('Create new form', 'formit') ?></a>
                    </p>
        ...
        public function formit_plugin_activation_redirect() {
            $route = new Formit_Route;
            // Redirect to the desired page or URL after plugin activation
            $redirect_url = $route->formit_create_url(); // Replace with your desired URL
